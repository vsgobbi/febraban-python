...
from febraban.cnab240.itau.transfer.transfer.header import Header
from febraban.cnab240.itau.transfer.transfer.segmentA import SegmentA
from febraban.cnab240.itau.transfer.transfer.trailer import Trailer
